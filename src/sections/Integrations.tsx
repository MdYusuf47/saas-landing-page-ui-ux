        ...
        <section className="py-24">
            <div className="container">
                ...
                <p className="text-white/50 mt-4 text-lg">
                    Layers seamlessly connects with your favorite too it easy to
                    plug into any workflow and collaborate platforms.
                </p>
                    ...
                    <div className=" flex flex-col gap-4 pb-4">
                        {integrations.map((integration) => (
                            ...
                            >
                                ...
                                <p className=" text-center text-white/15 mt-2">
